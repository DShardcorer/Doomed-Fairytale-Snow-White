...
namespace DefaultNamespace.LightingSystem
{
 /// <summary>
    ...
    public class LightInterpolatorEditor : Editor
    {
        ...
        private DayCycleLightingManager _mDayCycleLightingManager;
        ...
        private void OnEnable()
        {
            ...
            _mDayCycleLightingManager = GameObject.FindFirstObjectByType<DayCycleLightingManager>();
            if (_mDayCycleLightingManager != null)
            {
                _mDayCycleLightingManager.UpdateLight(0.0f);
            }
        ...
        void SceneUpdate()
        {
            if (m_PreviewSlider == null ||
                m_Interpolator == null ||
                _mDayCycleLightingManager == null)
                return;
            
            m_Interpolator.SetRatio(m_PreviewSlider.value);
            _mDayCycleLightingManager.UpdateLight(m_PreviewSlider.value);
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            m_PreviewSlider.RegisterValueChangedCallback(evt =>
            {
                ...
                if (_mDayCycleLightingManager != null)
                {
                    m_PreviewSlider.label = $"Preview time {GameTimeUtility.NormalizedToFormatTime24Hour(m_PreviewSlider.value)} ({m_PreviewSlider.value})";
                    _mDayCycleLightingManager.UpdateLight(m_PreviewSlider.value);
                }
            });
